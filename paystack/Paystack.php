...
use app\paystack\Paystack\Helpers\Router;
 ...
 */
    ...
    /**
 * definedRoutes
 * gets routes defined in the Femibiwoye\Paystack\Routes namespace
 ...
 *
 * @access private
 * @see    Femibiwoye\Paystack\Routes\Router
 * @since  1.0
 */
 ...
 *                  Femibiwoye\Paystack\Routes namespace implementing
 *                  Femibiwoye\Paystack\Contracts\RouteInterface
        ...
        spl_autoload_register(
            ...
            */
            function ($class_name) {
                ...
                $file .= str_replace([ 'app\\paystack\\', '\\' ], ['', DIRECTORY_SEPARATOR ], $class_name) . '.php';
                include_once $file;
            }
        );
    }
